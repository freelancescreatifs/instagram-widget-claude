...
import { Calendar, RefreshCw, Settings, Camera, Heart, MessageCircle } from 'lucide-react';
...
const App = () => {
  ...
  // Données d'exemple avec vidéos et carrousels
  const mockPosts = [
    {
      id: '1',
      date: '2024-09-18',
      type: 'image',
      urls: ['https://picsum.photos/1080/1350?random=1'],
      caption: 'Belle journée ☀️'
    },
    {
      id: '2', 
      date: '2024-09-17',
      type: 'carousel',
      urls: [
        'https://picsum.photos/1080/1350?random=2',
        'https://picsum.photos/1080/1350?random=3',
        'https://picsum.photos/1080/1350?random=4'
      ],
      caption: 'Mes vacances 🏖️'
    },
    {
      id: '3',
      date: '2024-09-16',
      ...
      caption: 'Mon dernier reel 🎬'
    },
    {
      id: '4',
      date: '2024-09-15',
      type: 'image',
      urls: ['https://picsum.photos/1080/1350?random=5'],
      caption: 'Café du matin ☕'
    },
    {
      id: '5',
      date: '2024-09-14',
      type: 'carousel',
      urls: [
        'https://picsum.photos/1080/1350?random=6',
        'https://picsum.photos/1080/1350?random=7'
      ],
      caption: 'Weekend détente 🌿'
    },
    {
      id: '6',
      date: '2024-09-13',
  ...
  const loadProfile = () => {
    try {
      const saved = localStorage.getItem('instagram-widget-profile');
      if (saved) {
  ...
  const refreshFeed = () => {
    setRefreshing(true);
    setTimeout(() => {
      console.log('Feed actualisé');
      setRefreshing(false);
    }, 1000);
  };

  const connectNotion = () => {
    setNotionConfig({ connected: true });
  };
  ...
  return (
    <div className="max-w-md mx-auto bg-white border border-gray-200 shadow-lg">
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-xs text-gray-400 mt-1">
                Utilisez une image carrée (recommandé: 400×400px)
              </p>
            </div>
        ...
        <div className="bg-amber-50 border-l-4 border-amber-400 p-3 m-4">
          <div className="flex items-center">
            ...
            <p className="text-amber-700 text-sm">
              Connectez Notion pour synchroniser
            </p>
          </div>
        </div>
      )}
      ...
      <div className="mt-4 p-4 bg-gray-50 text-center text-xs text-gray-600">
        <p>Glissez-déposez pour réorganiser • Actualiser pour synchroniser</p>
      </div>
    </div>
  );
};
